...
const resources = {
  ...
  fr: {
    translation: {
      ...
      instructions: {
  findSymbol: "Trouvez le même symbole et cliquez dessus sur chacune des {{count}} cartes !",
},
symbolLabel: "Symbole",
...
gamePaused: "Jeu en pause",
  ...
  ua: {
    translation: {
      ...
      instructions: {
  findSymbol: "Знайдіть однаковий символ і натисніть на нього на кожній з {{count}} карт!",
},
symbolLabel: "Символ",
