export const fr = {
  translation: {
    ...
    scores: {
      title: "Scores",
      subtitle: "Filtrez par mode et comparez les scores des joueurs.",
      emptyTitle: "Aucun score",
      emptyText: "Lancez ce mode depuis Jouer pour voir son classement ici.",
    },
    ...
    gameModeDescriptions: {
      me: "Chaque joueur a une carte, trouvez le symbole commun avec la carte centrale, prenez cette carte et marquez le plus de cartes.",
      ...
      reset:
        "Toutes les cartes sont distribuées aux joueurs. Trouvez vite le symbole commun avec la défausse centrale pour vous de vos cartes en premier.",
      duel: "Deux joueurs essaient de prendre toutes les cartes de l'adversaire en repérant les correspondances plus vite.",
      smallPile:
        "Éparpillez les cartes sur la table et récupérez les paires le plus vite possible.",
    },
    aboutTitle: "À propos",
    aboutDescription:
    ...
    gameFeatures: {
      cards: "56 cartes hexagonales uniques",
